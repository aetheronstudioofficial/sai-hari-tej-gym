...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 flex items-center h-[60px] md:h-[76px] ${
          scrolled
            ? "bg-primary-bg/85 backdrop-blur-md border-b border-border-rgba shadow-lg"
            : "bg-transparent"
        }`}
      >
